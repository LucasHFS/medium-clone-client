...
const index = () => {
  return (
    <div className='flex-1 container mx-auto mt-7 flex flex-col items-center'>
        ...
        <Link className='text-center text-blue-700 hover:underline text-sm mt-3' href="/login">Have an account?</Link>
        <form className='flex flex-col items-end w-1/3'>
            <input placeholder='Username' type="username" className='w-full border rounded px-5 py-2 mt-5 
            ...
            focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500'></input>
            <button type='submit' className='bg-primary text-white px-5 py-2 mt-3 rounded-md hover:bg-slate-800'>Sign up</button>
        </form>
    </div>
  )
}
